...
.cfg-modal__tab--dirty { color: var(--warning-text); }
...
.cfg-modal__textarea:focus { border-color: var(--primary-text); }
...
.presets__input:focus { border-color: var(--primary-text); }
...
.relay__input:focus { border-color: var(--primary-text); }
